...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C381%20rows-8250df">
...
**Public extract:** 8,381 rows · **Live catalog:** 8,378 domains
...
- `energy.csv` — public CSV extract (8,381 rows)
- `energy.json` — public JSON extract (8,381 rows)
...
| ----------------------- | ------------------------------------------------ |
| 8,381-row public sample | 8,378 live domains                               |
